...
if (isset($_POST['target']) && isset($_POST['guess']))
{
    ...
    $numberGuessed = $_POST['guess']; // had to change to guess

    if ($numberGuessed < $numberTarget) // had to get of equal sign
    {
        $message = "Guess Higher";
    } elseif ($numberGuessed >$numberTarget) // had to get of equal sign
    {
        $message = "Guess Lower";
